...
class Bounced extends React.Component {
        ...
        render() {
            ...
            return ( < div style = { me.state.data.boxStyle } >

                < div className = "fn-bounced"
                onClick = { this.onClick } >
                < /div> < div className = "fn-bounced-main" >
                < div className = "fn-bounced-icon"
                onClick = { this.onClearInerval } > X < /div> < div className = "fn-bounced-title" >
                获取验证码练习 < /div> < div className = "fn-MT10" >
                < table className = "fn-table fn-table-text"
                width = "100%" >
                < tbody >
                < tr >
                < td width = "220px" >
                ...
                < /td> < td >
                < button className = "fn-input-button fn-input-button-small fn-H32"
                ref = "getData"
                style = {
                    { backgroundColor: this.state.interval ? "#ddd" : "", color: this.state.interval ? "#000" : "" } }
                onClick = { this.onInterval } > { this.state.interval ? this.state.time + "s 后发送给您" : "获取验证码" } < /button> < /td> < /tr> < /tbody> < /table> < div className = "fn-MT20"
                style = {
                    { textAlign: "center" } } >
                < button className = "fn-input-button fn-input-button-small fn-W100"
                onClick = { this.onClick } > 确认 < /button> < /div> < /div> < /div> < /div>)
